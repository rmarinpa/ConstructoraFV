...
Public Class Sincroniza6
    ...
    Public Function listar(ByVal id_obra As Integer, ByVal fecha As String) As DataTable
        ...
        nue_var.da = New MySqlDataAdapter("SELECT * FROM descuentos_empresa_v2 where id_obra = " & id_obra & " and Fecha >= '" & fecha & "'", nue_conexion.conex())
    ...
    Public Function listar_remoto(ByVal id_obra As Integer, ByVal fecha As String) As DataTable
        ...
        nue_var.da = New MySqlDataAdapter("SELECT * FROM descuentos_empresa_v2 where sincroniza <> 0  and id_obra = " & id_obra & " and Fecha >= '" & fecha & "'", nue_conexion.conex_remoto())
        nue_var.da.Fill(nue_var.dt)
    ...
    Public Sub insertar(ByVal sincroniza As Integer, ByVal version As Integer, ByVal nombre_obra As String, ByVal id_obra As Integer, ByVal Nombre_representante As String, ByVal rut As String, ByVal Clasificacion As String, ByVal Descripcion As String, ByVal Cantidad As Double, ByVal unidad As String, ByVal precio_unitario As Double, ByVal Total As Double, ByVal Cuenta_contable As String, ByVal Fecha As Date)
        ...
        Try
            ...
            nue_conexion.desconectar_remoto()
            nue_var.consulta = "SELECT MAX(Id_descuentos) from descuentos_empresa_v2"
            Try
                nue_conexion.conectar_remoto()
                nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex_remoto())
                nue_var.dr = nue_var.cmd.ExecuteReader()
                If nue_var.dr.Read Then
                    idd_sincroniza = nue_var.dr("MAX(Id_descuentos)")
                End If
                nue_var.dr.Close()
                nue_conexion.desconectar_remoto()
        ...
        End Try
    End Sub
    Public Sub insertar_remoto(ByVal sincroniza As Integer, ByVal version As Integer, ByVal nombre_obra As String, ByVal id_obra As Integer, ByVal Nombre_representante As String, ByVal rut As String, ByVal Clasificacion As String, ByVal Descripcion As String, ByVal Cantidad As Double, ByVal unidad As String, ByVal precio_unitario As Double, ByVal Total As Double, ByVal Cuenta_contable As String, ByVal Fecha As Date)
        nue_var.consulta = "INSERT INTO descuentos_empresa_v2 (sincroniza, version, nombre_obra, id_obra, Nombre_representante, rut, Clasificacion, Descripcion, Cantidad, unidad, precio_unitario, Total, Cuenta_contable, Fecha) VALUES(?sincroniza, ?version, ?nombre_obra, ?id_obra, ?Nombre_representante, ?rut, ?Clasificacion, ?Descripcion, ?Cantidad, ?unidad, ?precio_unitario, ?Total, ?Cuenta_contable, ?Fecha)"
        Try
    ...
    Public Sub modificar(ByVal Id_identificacion As Integer, ByVal sincroniza As Integer)
        nue_var.consulta = "UPDATE descuentos_empresa_v2 SET sincroniza = ?sincroniza WHERE Id_descuentos = ?Id_identificacion"
        Try
            nue_conexion.conectar()
    ...
    '    nue_var.dt = New DataTable
    '    nue_conexion.conectar_remoto()
    '    nue_var.da = New MySqlDataAdapter("SELECT * FROM descuentos_empresa_v2 where sincroniza <> 0  and sincroniza <> 1 and id_obra = " & id_obra & "", nue_conexion.conex_remoto())
    '    nue_var.da.Fill(nue_var.dt)
    '    nue_conexion.desconectar_remoto()
    ...
    End Function
    Public Sub modificar_tabla(ByVal Cod_adicional As Integer, ByVal sincroniza As Integer, ByVal version As Integer, ByVal nombre_obra As String, ByVal id_obra As Integer, ByVal Nombre_representante As String, ByVal rut As String, ByVal Clasificacion As String, ByVal Descripcion As String, ByVal Cantidad As Double, ByVal unidad As String, ByVal precio_unitario As Double, ByVal Total As Double, ByVal Cuenta_contable As String, ByVal Fecha As Date)
    ...
    Public Sub modificar_eliminar(ByVal Cod_identifica As Integer, ByVal sincroniza As Integer, ByVal version As Integer)
        nue_var.consulta = "UPDATE descuentos_empresa_v2 SET sincroniza = ?sincroniza, version = ?version WHERE Id_descuentos = ?Cod_identifica"
        Try
            nue_conexion.conectar()
            nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex())
    ...
    Public Sub modificar_temporal2(ByVal Id_seccion As Integer, ByVal Id_secundario As Integer, ByVal Id_obra As Integer, ByVal version As Integer)
        ...
        End Try
    End Sub
    Public Function verificar_version2(ByVal Id_descuentos As Integer, ByVal Id_obra As Integer) As Integer
        nue_var.consulta = "SELECT version FROM descuentos_empresa_v2 WHERE Id_descuentos = ?Id_descuentos and id_obra = ?Id_obra"
        nue_conexion.conectar_remoto()
        nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex_remoto())
        nue_var.cmd.Parameters.Add("?Id_descuentos", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = Id_descuentos
        nue_var.cmd.Parameters.Add("?Id_obra", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = Id_obra
        nue_var.dr = nue_var.cmd.ExecuteReader()
        If nue_var.dr.Read Then
    ...
    End Function
    Public Sub modificar_remoto2(ByVal Cod_adicional As Integer, ByVal sincroniza As Integer, ByVal version As Integer, ByVal nombre_obra As String, ByVal id_obra As Integer, ByVal Nombre_representante As String, ByVal rut As String, ByVal Clasificacion As String, ByVal Descripcion As String, ByVal Cantidad As Double, ByVal unidad As String, ByVal precio_unitario As Double, ByVal Total As Double, ByVal Cuenta_contable As String, ByVal Fecha As Date)
        nue_var.consulta = "UPDATE descuentos_empresa_v2 SET sincroniza = ?sincroniza, version = ?version, nombre_obra = ?nombre_obra, id_obra = ?id_obra, Nombre_representante = ?Nombre_representante, rut = ?rut,  Clasificacion = ?Clasificacion, Descripcion = ?Descripcion, Cantidad = ?Cantidad, unidad = ?unidad, precio_unitario = ?precio_unitario, Total = ?Total, Cuenta_contable = ?Cuenta_contable, Fecha = ?Fecha WHERE Id_descuentos = ?Cod_adicional"
        Try
            nue_conexion.conectar_remoto()
            nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex_remoto())
