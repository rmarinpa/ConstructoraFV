...
Public Class boleta_garantia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.boleta_garantia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nom_corto() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedboleta_garantia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As boleta_garantia = New boleta_garantia()
        rpt.Site = Me.Site
        Return rpt
    End Function
