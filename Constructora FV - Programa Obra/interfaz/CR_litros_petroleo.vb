...
Public Class CR_litros_petroleo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.CR_litros_petroleo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_litros_petroleo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_litros_petroleo = New CR_litros_petroleo()
        rpt.Site = Me.Site
        Return rpt
    End Function
