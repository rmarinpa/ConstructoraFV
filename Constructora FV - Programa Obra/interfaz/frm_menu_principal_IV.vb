...
Public Class frm_menu_principal_IV
    ...
    Sub desbloquear1()
        ...
        cmb_1_cuenta_serv.Enabled = True
        txt_1_plazo_dias.Enabled = True
        'txt_1_valor_pesos.Enabled = True
        txt_1_valor_contrato.Enabled = True
        'cmb_1_item.Enabled = True
        txt_1_cant_cont.Enabled = True
    ...
    Sub limpiar1()
        ...
        txt_1_precio_total.Clear()
        txt_1_capacidad.Clear()
        cmb_1_obra.Text = ""
        cmb_1_un_pago.Text = ""
        txt_1_precio_un.Clear()
        cmb_1_cuenta_serv.Text = ""
    ...
    Private Sub frm_menu_principal_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        With dtp_8_fecha_inicial
            ...
            .CustomFormat = "24 MMMM yyyy"
            .MaxDate = Today.AddMonths(1).AddDays(24 - Today.Day)
    ...
    Private Sub btn_guardar1_Click(sender As Object, e As EventArgs) Handles btn_guardar1.Click
        Dim rut, domicilio, obra, cuenta_contable, razon_social, representante, representante_rut, servicio, comuna, ciudad, item, unidad_pago As String
        Dim precio_un, valor_pesos, plazo_dias, valor_contrato, cantidad, precio_total, valor_seguro As Double
        'Dim num_resolucion, fecha_ep, fecha_ep2 As Integer
        'Dim fecha_fin As Date

        If (txt_1_rut.Text <> "" And txt_1_razon_social.Text <> "" And cmb_1_servicio.Text <> "" And cmb_1_item.Text <> "" And cmb_1_un_pago.Text <> "" And txt_1_precio_un.Text <> "" And txt_1_cant_cont.Text <> "" And cmb_1_cuenta_serv.Text <> "") Then
            sincroniza_local = 1
            ...
            If Not IsNumeric(txt_1_cant_cont.Text) Then
                cantidad = 0
            Else
                cantidad = CDbl(txt_1_cant_cont.Text)
            End If

            If Not IsNumeric(txt_1_precio_total.Text) Then
                precio_total = 0
            Else
                precio_total = CDbl(txt_1_precio_total.Text)
            End If
            ...
            servicio = cmb_1_servicio.Text
            item = cmb_1_item.Text
            unidad_pago = cmb_1_un_pago.Text
            obra = cmb_1_obra.Text
            cuenta_contable = cmb_1_cuenta_serv.Text
            ...
            If sw1 = 0 Then
                ...
                End If
                nue_obra1.insertar_posicion(1, 0, Nombre_Obra, id_obra, rut, servicio, item, unidad_pago, precio_un, cantidad, precio_total, obra, cuenta_contable, plazo_dias, valor_contrato, valor_pesos, valor_seguro)

                actualizar_dgv1()
                actualiza_equipos()
            Else
                version_mod1 = version_mod1 + 1
                nue_obra1.modificar_posicion(CInt(Cod_1), 2, version_mod1, Nombre_Obra, id_obra, rut, servicio, item, unidad_pago, precio_un, cantidad, precio_total, obra, cuenta_contable, plazo_dias, valor_contrato, valor_pesos, valor_seguro)
                actualizar_dgv1()
                actualiza_equipos()
            End If
            limpiar1()
    ...
    Private Sub btn_eliminar3_Click(sender As Object, e As EventArgs) Handles btn_eliminar3.Click
        ...
        Else
            ...
            If eliminar3 = MsgBoxResult.Ok Then
    ...
    Private Sub btn_editar1_Click(sender As Object, e As EventArgs) Handles btn_editar1.Click
        ...
        Else
            ...
            txt_1_comuna.Enabled = False
            txt_1_ciudad.Enabled = False
            'cmb_1_servicio.Text = dgv_1_subcontratos.CurrentRow.Cells(10).Value.ToString()
        End If
    End Sub
    Sub actualizar_dgv1()
        ...
        dgv_1_subcontratos.Columns(2).Visible = False
        ...
        dgv_1_subcontratos.Columns(12).HeaderText = "Subcontrato"
        dgv_1_subcontratos.Columns(12).Width = 150
        dgv_1_subcontratos.Columns(13).HeaderText = "Ítem"
        dgv_1_subcontratos.Columns(13).Width = 200
        dgv_1_subcontratos.Columns(14).Visible = False
        dgv_1_subcontratos.Columns(15).Visible = False
        dgv_1_subcontratos.Columns(16).Visible = False
        dgv_1_subcontratos.Columns(17).Visible = False
        dgv_1_subcontratos.Columns(18).Visible = False
        dgv_1_subcontratos.Columns(19).Visible = False
        dgv_1_subcontratos.Columns(20).Visible = False
        dgv_1_subcontratos.Columns(21).Visible = False
        dgv_1_subcontratos.Columns(22).Visible = False
        dgv_1_subcontratos.Columns(23).Visible = False
        dgv_1_subcontratos.Columns(24).Visible = False
    ...
    Private Sub txt_1_razon_social_TextChanged(sender As Object, e As EventArgs) Handles txt_1_razon_social.TextChanged
        If Len(txt_1_razon_social.Text) > 0 Then
            ...
            If dgv_arrendador.Rows.Count > 1 Then
                ...
                cmb_1_servicio.DataSource = nue_obra1.listar8(id_obra, txt_1_rut.Text)
                cmb_1_servicio.DisplayMember = "servicio"
                cmb_1_servicio.ValueMember = "id_obra"
            ...
            Else
                ...
                cmb_1_servicio.DataSource = nue_obra1.listar8(id_obra, txt_1_rut.Text)
                cmb_1_servicio.DisplayMember = "servicio"
                cmb_1_servicio.ValueMember = "obra"
    ...
    Private Sub dgv_1_maquinas_MouseClick(sender As Object, e As MouseEventArgs) Handles dgv_1_subcontratos.MouseClick
        Cod_1 = dgv_1_subcontratos.CurrentRow.Cells(6).Value.ToString()

        'txt_1_domicilio.Text = dgv_1_subcontratos.CurrentRow.Cells(0).Value.ToString()
        'txt_1_razon_social.Text = ""
        txt_1_razon_social.Text = dgv_1_subcontratos.CurrentRow.Cells(1).Value.ToString()
        'txt_1_representante.Text = dgv_1_subcontratos.CurrentRow.Cells(2).Value.ToString()
        'txt_1_rut_representante.Text = dgv_1_subcontratos.CurrentRow.Cells(3).Value.ToString()
        'txt_1_rut.Text = dgv_1_subcontratos.CurrentRow.Cells(9).Value.ToString()

        cmb_1_servicio.Text = dgv_1_subcontratos.CurrentRow.Cells(12).Value.ToString()
        cmb_1_item.Text = dgv_1_subcontratos.CurrentRow.Cells(13).Value.ToString()

        cmb_1_un_pago.Text = dgv_1_subcontratos.CurrentRow.Cells(14).Value.ToString()
        txt_1_precio_un.Text = dgv_1_subcontratos.CurrentRow.Cells(15).Value.ToString()
        txt_1_cant_cont.Text = dgv_1_subcontratos.CurrentRow.Cells(16).Value.ToString()

        cmb_1_cuenta_serv.Text = dgv_1_subcontratos.CurrentRow.Cells(19).Value.ToString()
        txt_1_plazo_dias.Text = dgv_1_subcontratos.CurrentRow.Cells(20).Value.ToString()
        txt_1_valor_contrato.Text = dgv_1_subcontratos.CurrentRow.Cells(21).Value.ToString()

        txt_1_valor_seguro.Text = dgv_1_subcontratos.CurrentRow.Cells(23).Value.ToString()
        cmb_1_obra.Text = dgv_1_subcontratos.CurrentRow.Cells(18).Value.ToString()

        sincroniza_local = CInt(dgv_1_subcontratos.CurrentRow.Cells(7).Value.ToString())
        version_mod1 = CInt(dgv_1_subcontratos.CurrentRow.Cells(8).Value.ToString())
        sincroniza_mod1 = 2
    End Sub
    ...
    Public Sub actualiza_cuentas_maquinaria()
        cmb_1_cuenta_serv.DataSource = nue_obra1.listar6(id_obra)
        cmb_1_cuenta_serv.DisplayMember = "Cuenta_costo"
        cmb_1_cuenta_serv.ValueMember = "Cuenta_costo"
    End Sub
    ...
    Private Sub btn_tabla_Click(sender As Object, e As EventArgs) Handles btn_tabla.Click
        ...
        If dgv_datosAgregados.Rows.Count > 0 Then
            For i = 0 To dgv_datosAgregados.Rows.Count - 1
                ...
                If IsNumeric(dgv_datosAgregados.Rows(i).Cells(6).Value) Then
                ...
                End If
            Next i
            If consulta_datos = 1 Then
                actualizar_dgv()
                actualiza_columnas()
            ElseIf consulta_datos = 2 Then
                actualizar_dgv_equipo()
                actualiza_columnas()
            End If
            consulta_datos = 0
    ...
    Private Sub dgv_3_trabajos_adicionales_MouseClick(sender As Object, e As MouseEventArgs) Handles dgv_3_trabajos_adicionales.MouseClick
        ...
        cmb_3_cuenta_contable.Text = dgv_3_trabajos_adicionales.CurrentRow.Cells(14).Value.ToString()
    ...
    Public Sub actualizar_check()
        Dim subcontratista As String
        Dim subcontrato As String

        Dim Cadena As String = cmb_4_subcontrato.Text
        Dim ArrCadena As String() = Cadena.Split("/")

        subcontratista = ArrCadena(0)
        subcontrato = ArrCadena(1)

        dgv_4_equipos.DataSource = nue_obra4.listar2(id_obra, cmb_4_subcontrato.SelectedValue.ToString(), subcontrato)
    ...
    Private Sub cmb_4_arrendador_TextChanged(sender As Object, e As EventArgs) Handles cmb_4_subcontrato.TextChanged
        If cmb_4_subcontrato.Text <> "" And activa = 1 Then
            actualizar_check()
        End If
    End Sub
    ...
    Private Sub txt_1_capacidad_TextChanged(sender As Object, e As EventArgs) Handles txt_1_capacidad.TextChanged
        If cmb_1_servicio.Text = "M3-KM" And Not IsNumeric(txt_1_capacidad.Text) Then
            txt_1_capacidad.Clear()
    ...
    Sub actualizar_5_adjuntos()
        ...
        dgv_5_empresa.Columns(5).Width = 150
        dgv_5_empresa.Columns(6).HeaderText = "Subcontrato"
        dgv_5_empresa.Columns(6).Width = 150
        dgv_5_empresa.Columns(7).HeaderText = "Número Contrato"
        dgv_5_empresa.Columns(7).Width = 100
    ...
    Private Sub txt_1_max_dias_TextChanged(sender As Object, e As EventArgs) Handles txt_1_plazo_dias.TextChanged
        ...
        End If
    End Sub
    Private Sub cmb_1_item_TextChanged(sender As Object, e As EventArgs) Handles cmb_1_item.TextChanged
        If cmb_1_item.Text <> "" Then
    ...
    Private Sub txt_1_precio_un_TextChanged(sender As Object, e As EventArgs) Handles txt_1_precio_un.TextChanged
        ...
        If Not IsNumeric(txt_1_precio_un.Text) Then
            txt_1_precio_un.Clear()
        End If
        If IsNumeric(txt_1_precio_un.Text) And IsNumeric(txt_1_cant_cont.Text) Then
            precio_total = txt_1_precio_un.Text * txt_1_cant_cont.Text
            txt_1_precio_total.Text = FormatNumber(precio_total, 0)
        Else
        End If
    End Sub

    Private Sub txt_1_cant_cont_TextChanged(sender As Object, e As EventArgs) Handles txt_1_cant_cont.TextChanged
        Dim precio_total As Double
        If Not IsNumeric(txt_1_cant_cont.Text) Then
            txt_1_cant_cont.Clear()
        End If
    ...
    Private Sub txt_1_valor_contrato_TextChanged(sender As Object, e As EventArgs) Handles txt_1_valor_contrato.TextChanged
        ...
        If Not IsNumeric(txt_1_cant_cont.Text) Then
            txt_1_cant_cont.Clear()
        End If
        If IsNumeric(txt_1_valor_contrato.Text) And IsNumeric(txt_1_precio_total.Text) Then
            valor_garantia = (txt_1_precio_total.Text * txt_1_valor_contrato.Text) / 100
    ...
    Private Sub cmb_1_servicio_TextChanged(sender As Object, e As EventArgs) Handles cmb_1_servicio.TextChanged
        Dim var1 As String
        cmb_1_item.DataSource = nue_obra1.listar9(id_obra, txt_1_rut.Text, cmb_1_servicio.Text)
        cmb_1_item.DisplayMember = "item"
        cmb_1_item.ValueMember = "item"
        cmb_1_item.Text = ""
        cmb_1_item.Enabled = True
        'If nue_obra1.verificar_servicio(id_obra, txt_1_rut.Text, cmb_1_servicio.Text) = 1 Then
        '    cmb_1_obra.Enabled = False
        '    var1 = cmb_1_servicio.Text
        '    cmb_1_servicio.DataSource = nue_obra1.listar8(id_obra, txt_1_rut.Text)
        '    cmb_1_servicio.DisplayMember = "servicio"
        '    cmb_1_servicio.ValueMember = "obra"
        '    cmb_1_servicio.Text = var1
        '    cmb_1_obra.Text = cmb_1_servicio.SelectedValue.ToString()
        'Else
        '    cmb_1_obra.Enabled = True
        'End If
    End Sub
    Private Sub cmb_5_subcontrato_TextChanged(sender As Object, e As EventArgs) Handles cmb_5_subcontrato.TextChanged
        ...
        If activa = 1 Then
            ...
            subcontratista = ArrCadena(0)
            subcontrato = ArrCadena(1)
            cmb_5_obra.Text = nue_obra5.verificar_obra(id_obra, cmb_5_subcontrato.SelectedValue.ToString(), subcontrato)
