...
Public Class Boletas_consulta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Boletas_consulta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBoletas_consulta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Boletas_consulta = New Boletas_consulta()
        rpt.Site = Me.Site
        Return rpt
    End Function
