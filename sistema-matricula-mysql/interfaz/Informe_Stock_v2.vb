...
Public Class Informe_Stock_v2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_Stock_v2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_Stock_v2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_Stock_v2 = New Informe_Stock_v2()
        rpt.Site = Me.Site
        Return rpt
    End Function
