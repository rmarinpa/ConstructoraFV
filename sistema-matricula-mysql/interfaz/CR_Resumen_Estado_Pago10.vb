Public Class CR_Resumen_Estado_Pago10
    ...
    Private Sub CR_Estado_de_pago_Load(sender As Object, e As EventArgs) Handles Me.Load
        If sincroniza = 0 Then
            ...
            If frm_menu_principal_X.chk_iva.Checked = True Then
                IVA = "SI"
            ElseIf frm_menu_principal_X.chk_iva.Checked = False Then
                IVA = "NO"
            End If
            ...
            Report1.SetParameterValue("rut", frm_menu_principal_X.cmb_10_arrendador.SelectedValue.ToString())
            Report1.SetParameterValue("n_ep", frm_menu_principal_X.txt_10_ep.Text)
            Report1.SetParameterValue("iva", IVA)
            Report1.SetParameterValue("nombre", frm_menu_principal_X.cmb_10_arrendador.Text)
            Report1.SetParameterValue("obra", Nombre_Obra)
            CrystalReportViewer1.ReportSource = Report1

        ElseIf sincroniza = 1 Then
            Dim Report1 As New Resumen_Estado_de_pago_v2_fechas_local2
            'Dim mes_final As Integer
            'Dim mes_ep1, año_ep2 As String
            Dim fecha_inicial As Date
            Dim fecha_final As Date
