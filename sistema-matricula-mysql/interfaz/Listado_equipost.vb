...
Public Class Listado_equipost
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Listado_equipost.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListado_equipost
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Listado_equipost = New Listado_equipost()
        rpt.Site = Me.Site
        Return rpt
    End Function
