...
Public Class Listado_equipos_te
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Listado_equipos_te.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListado_equipos_te
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Listado_equipos_te = New Listado_equipos_te()
        rpt.Site = Me.Site
        Return rpt
    End Function
