...
Public Class EstadoPagoMandante2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EstadoPagoMandante2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.EstadoPagoMandante2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadoPagoMandante2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadoPagoMandante2 = New EstadoPagoMandante2()
        rpt.Site = Me.Site
        Return rpt
    End Function
