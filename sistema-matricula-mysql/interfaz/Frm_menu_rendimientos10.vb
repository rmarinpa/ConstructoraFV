...
Public Class Frm_menu_rendimientos10
    ...
    Private Sub btn_rendimientos_Click(sender As Object, e As EventArgs) Handles btn_rendimientos.Click
        ...
        pb_list.Maximum = 6
        pb_list.Value = 1
        Fecha_inicio = frm_menu_principal_X.dtp_8_fecha_inicial.Value.ToShortDateString
        Fecha_inicio = Format(CDate(Fecha_inicio), "yyyy/MM/dd")
        fecha_final = frm_menu_principal_X.dtp_8_fecha_final.Value.ToShortDateString
