...
Public Class CR_Cuentas_Contables4_local
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_Cuentas_Contables4_local.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.CR_Cuentas_Contables4_local.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Cuentas_Contables4_local
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Cuentas_Contables4_local = New CR_Cuentas_Contables4_local()
        rpt.Site = Me.Site
        Return rpt
    End Function
