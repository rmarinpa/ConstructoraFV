Public Class frm_menu_principal
        ...
        If dgv_sincroniza1.Rows.Count > 1 Then
            For i = 0 To dgv_sincroniza1.Rows.Count - 2
                If CInt(dgv_sincroniza1.Rows(i).Cells(1).Value.ToString()) = 1 Then
                    nue_sincroniza.insertar(1, 0, dgv_sincroniza1.Rows(i).Cells(3).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(4).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(5).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(6).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(7).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(8).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(9).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(10).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(11).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(12).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(13).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(14).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(15).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(16).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(17).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(18).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(19).Value.ToString())
                ...
                ElseIf CInt(dgv_sincroniza1.Rows(i).Cells(1).Value.ToString()) = 2 Or CInt(dgv_sincroniza1.Rows(i).Cells(1).Value.ToString()) = 3 And modifica_local = 1 Then
                    If nue_sincroniza.verificar_version(seccion, id_obra, dgv_sincroniza1.Rows(i).Cells(0).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(2).Value.ToString()) = 1 Then
                        ...
                        Else
                            nue_sincroniza.modificar_remoto2(Id_primario, dgv_sincroniza1.Rows(i).Cells(1).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(2).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(3).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(4).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(5).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(6).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(7).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(8).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(9).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(10).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(11).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(12).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(13).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(14).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(15).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(16).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(17).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(18).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(19).Value.ToString())
    ...
    Sub sincroniza_4()
        ...
        If dgv_sincroniza1.Rows.Count > 1 Then
            For i = 0 To dgv_sincroniza1.Rows.Count - 2
                If CInt(dgv_sincroniza1.Rows(i).Cells(1).Value.ToString()) = 1 Then
                    nue_sincroniza4.insertar(1, 0, dgv_sincroniza1.Rows(i).Cells(3).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(4).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(5).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(6).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(7).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(8).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(9).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(10).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(11).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(12).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(13).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(14).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(15).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(16).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(17).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(18).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(19).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(20).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(21).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(22).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(23).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(24).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(25).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(26).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(27).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(28).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(29).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(30).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(31).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(32).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(33).Value.ToString())
                ...
                ElseIf CInt(dgv_sincroniza1.Rows(i).Cells(1).Value.ToString()) = 2 Or CInt(dgv_sincroniza1.Rows(i).Cells(1).Value.ToString()) = 3 Then
                    If nue_sincroniza4.verificar_version(seccion, id_obra, dgv_sincroniza1.Rows(i).Cells(0).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(2).Value.ToString()) = 1 Then
                        ...
                        Else
                            nue_sincroniza4.modificar_remoto2(Id_primario, dgv_sincroniza1.Rows(i).Cells(1).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(2).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(3).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(4).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(5).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(6).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(7).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(8).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(9).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(10).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(11).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(12).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(13).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(14).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(15).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(16).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(17).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(18).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(19).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(20).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(21).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(22).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(23).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(24).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(25).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(26).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(27).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(28).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(29).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(30).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(31).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(32).Value.ToString(), dgv_sincroniza1.Rows(i).Cells(33).Value.ToString())
    ...
    'Private Sub TabPage6_Enter(sender As Object, e As EventArgs) Handles TabPage5.Enter
    '   num_tab = 1
    '  frm_menu_principal_VI.Show()
    ' Me.Close()
    'End Sub
    Private Sub TabPage7_Enter(sender As Object, e As EventArgs) Handles TabPage6.Enter
        num_tab = 1
        frm_menu_principal_VI.Show()
        Me.Close()
    End Sub
