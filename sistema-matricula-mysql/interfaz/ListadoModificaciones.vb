...
Public Class ListadoModificaciones
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ListadoModificaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.ListadoModificaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoModificaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoModificaciones = New ListadoModificaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
