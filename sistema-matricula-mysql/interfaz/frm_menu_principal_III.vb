...
Public Class frm_menu_principal_III
    ...
    Private Sub frm_menu_principal_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        actualiza_arrendador9()
        actualizar_9_adjuntos()
    ...
    Private Sub btn_guardar1_Click(sender As Object, e As EventArgs) Handles btn_guardar1.Click
        ...
        Dim un_medida, activo As String
                ...
                If (cmb_1_forma.Text <> "Mes" And cmb_1_forma.Text <> "Dia" And txt_1_min.Text <> "" And txt_1_desc.Text <> "") Or cmb_1_forma.Text = "Mes" Or cmb_1_forma.Text = "Dia" Then
                    ...
                    If sw1 = 0 Then
                        If existe_rut = 1 Then
                            ...
                            End If
                        End If
                        nue_obra1.insertar_posicion(1, 0, Nombre_Obra, id_obra, rut, forma, fecha_ep, fecha_ep2, codigo, tipo_equipo, detalle_equipo, marca, modelo, patente, num_motor, capacidad, obra, operador, horometro, un_pago, precio_un, cuenta_maq, cuenta_petro, recupera, dias_fallas, jornada, min, desc, material, turno, rendimiento, un_medida, activo)
                    ...
                    ElseIf sincroniza_local_1 = 1 And sincroniza = 1 And sw1 <> 0 Then
                        If existe_rut = 1 Then
                            ...
                            End If
                        End If
                        nue_obra1.modificar_posicion(CInt(Cod_1), 1, 0, Nombre_Obra, id_obra, rut, forma, fecha_ep, fecha_ep2, codigo, tipo_equipo, detalle_equipo, marca, modelo, patente, num_motor, capacidad, obra, operador, horometro, un_pago, precio_un, cuenta_maq, cuenta_petro, recupera, dias_fallas, jornada, min, desc, material, turno, rendimiento, un_medida, activo)
                        actualizar_dgv1()
                        actualiza_equipos()
    ...
    Private Sub btn_eliminar1_Click(sender As Object, e As EventArgs) Handles btn_eliminar1.Click
        ...
        Else
            ...
            If nue_obra1.suma_petroleo(CInt(Cod_1), id_obra) = 0 Then

                If nue_obra1.suma_reports(CInt(Cod_1), id_obra) = 0 Then
                ...
                Else
                    MessageBox.Show("NO SE PUEDE ELIMINAR MÁQUINA DADO QUE TIENE REPORTS INGRESADOS")
                End If
            Else
                MessageBox.Show("NO SE PUEDE ELIMINAR MÁQUINA DADO QUE TIENE PETRÓLEO INGRESADO")
            End If
    ...
    Sub actualizar_dgv1()
        ...
        dgv_1_maquinas.Columns(36).Visible = False
        dgv_1_maquinas.Columns(37).Visible = False
    ...
    Public Sub actualiza_arrendador9()
        cmb_9_arrendador.DataSource = nue_obra8.listar3(id_obra)
        cmb_9_arrendador.DisplayMember = "razon_social"
        cmb_9_arrendador.ValueMember = "rut"
    End Sub
    ...
    Private Sub dgv_1_maquinas_MouseClick(sender As Object, e As MouseEventArgs) Handles dgv_1_maquinas.MouseClick
        ...
        cmb_1_unidad.Text = dgv_1_maquinas.CurrentRow.Cells(36).Value.ToString()
        ...
        cmb_1_cuenta_maq.SelectedValue = dgv_1_maquinas.CurrentRow.Cells(26).Value.ToString()
        cmb_1_cuenta_petro.SelectedValue = dgv_1_maquinas.CurrentRow.Cells(27).Value.ToString()
        ...
        cmb_1_activo.Text = dgv_1_maquinas.CurrentRow.Cells(37).Value.ToString()
    ...
    Public Sub actualiza_equipos()
        cmb_equipo.DataSource = nue_obra1.listar2_reports(id_obra)
    ...
    Public Sub actualiza_cuentas_maquinaria()
        ...
        cmb_1_cuenta_maq.DisplayMember = "cuenta_desc"
    ...
    Public Sub actualiza_cuentas_petroleo()
        ...
        cmb_1_cuenta_petro.DisplayMember = "cuenta_desc"
    ...
    Private Sub dgv_3_trabajos_adicionales_MouseClick(sender As Object, e As MouseEventArgs) Handles dgv_3_trabajos_adicionales.MouseClick
        Try
            ...
            cmb_3_cuenta_contable.SelectedValue = dgv_3_trabajos_adicionales.CurrentRow.Cells(13).Value.ToString()
    ...
    Public Sub Genera_word()
        ...
        If SaveFileDialog2.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            ...
            Documento.Bookmarks.Item("un_medida1").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 2 Then
                ...
                Documento.Bookmarks.Item("un_medida2").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 3 Then
                ...
                Documento.Bookmarks.Item("un_medida3").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 4 Then
                ...
                Documento.Bookmarks.Item("un_medida4").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 5 Then
                ...
                Documento.Bookmarks.Item("un_medida5").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 6 Then
                ...
                Documento.Bookmarks.Item("un_medida6").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 7 Then
                ...
                Documento.Bookmarks.Item("un_medida7").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
            ...
            If contador >= 8 Then
                ...
                Documento.Bookmarks.Item("un_medida8").Range.Text = dgv_4_equipos2.Rows(0).Cells(46).Value.ToString()
    ...
    Private Sub btn_eliminar11_Click(sender As Object, e As EventArgs) Handles btn_eliminar11.Click
        ...
        If (Cod_11 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            If nue_obra1.suma_maquinas(txt_1_rut.Text, id_obra) = 0 Then
            ...
            Else
                MessageBox.Show("NO SE PUEDE ELIMINAR ARRENDADOR PORQUE TIENE MÁQUINAS ASIGNADAS")
            End If
        End If
    End Sub
    ...
    Private Sub btn_listado_Click(sender As Object, e As EventArgs) Handles btn_listado.Click
        Frm_listado_maquinas.ShowDialog()
    End Sub
    ...
    Private Sub Button98_Click(sender As Object, e As EventArgs) Handles btn_8_adjuntar_ep.Click
        Dim ruta As String
        Dim nombre As String
        Dim extension As String
        Dim verificar As Integer
        ...
        If IsNumeric(txt_9_ep.Text) Then
            If dgv_9_empresa.Rows.Count > 0 Then
                For j = 0 To dgv_9_empresa.Rows.Count - 1
                    If cmb_9_arrendador.SelectedValue.ToString() = dgv_9_empresa.Rows(j).Cells(5).Value.ToString() And txt_9_ep.Text = dgv_9_empresa.Rows(j).Cells(7).Value.ToString() Then
                        verificar = 1
                    End If
                Next j
            End If
            ...
            If verificar <> 1 Then
                ...
                If OpenFileDialog7.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ruta = OpenFileDialog7.FileName
                    nombre = cmb_9_arrendador.SelectedValue.ToString() & "-" & txt_9_ep.Text & "-" & id_obra
                    extension = ".pdf"

                    nue_obra5.insertar_ep_adjunto(1, 0, Nombre_Obra, id_obra, cmb_9_arrendador.SelectedValue.ToString(), cmb_9_arrendador.Text, CInt(txt_9_ep.Text), "SI", Nombre_Usuario, CDate(txt_fecha_act.Text), CDate(txt_hora.Text))
                    actualizar_9_adjuntos()

                    My.Computer.Network.UploadFile(ruta, "ftp://cfv%2540constructorafv.com@201.148.105.75/Estados_Pago_Maq/" & nombre & extension & "", "cfv@constructorafv.com", "gsolis2013", True, 500)
                    MessageBox.Show("ESTADO DE PAGO ADJUNTO")

                    txt_9_ep.Clear()

                End If
            Else
                MessageBox.Show("EL N° DE ESTADO DE PAGO " & txt_9_ep.Text & " YA ESTA ADJUNTADO")
            End If
        Else
            MessageBox.Show("FALTA INGRESAR EL N° DEL ESTADO DE PAGO")
        End If


    End Sub

    Private Sub btn_descargar9_Click(sender As Object, e As EventArgs) Handles btn_descargar9.Click
        If (Cod_9 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            descargar_ep()
    ...
    Sub actualizar_9_adjuntos()
        dgv_9_empresa.DataSource = nue_obra5.listar_ep(id_obra)
        dgv_9_empresa.Columns(0).Visible = False
        dgv_9_empresa.Columns(1).Visible = False
        dgv_9_empresa.Columns(2).Visible = False
        dgv_9_empresa.Columns(3).Visible = False
        dgv_9_empresa.Columns(4).Visible = False
        dgv_9_empresa.Columns(5).HeaderText = "RUT"
        dgv_9_empresa.Columns(5).Width = 100
        dgv_9_empresa.Columns(6).HeaderText = "Nombre Empresa"
        dgv_9_empresa.Columns(6).Width = 300
        dgv_9_empresa.Columns(7).HeaderText = "Número EP"
        dgv_9_empresa.Columns(7).Width = 80
        dgv_9_empresa.Columns(8).HeaderText = "Adjunto"
        dgv_9_empresa.Columns(8).Width = 70
        dgv_9_empresa.Columns(9).HeaderText = "Usuario"
        dgv_9_empresa.Columns(9).Width = 70
        dgv_9_empresa.Columns(10).HeaderText = "Fecha"
        dgv_9_empresa.Columns(10).Width = 100
        dgv_9_empresa.Columns(11).Visible = False
        dgv_9_empresa.AllowUserToOrderColumns = True
    End Sub
    ...
    Private Sub btn_eliminar9_Click(sender As Object, e As EventArgs) Handles btn_eliminar9.Click
        ...
        If (Cod_9 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            eliminar9 = MsgBox("¿Realmente desea eliminar el Estado de Pago designado al Representante?", MsgBoxStyle.YesNo, "Confirmar")

            If eliminar9 = MsgBoxResult.Yes Then
                nue_obra5.eliminar_sincro_ep(CInt(Cod_9), 3, version_mod9)
                txt_9_rut.Clear()
                txt_9_empresa.Clear()
                txt_9_n_ep.Clear()
                Cod_9 = ""
    ...
    Private Sub dgv_9_empresa_MouseClick(sender As Object, e As MouseEventArgs) Handles dgv_9_empresa.MouseClick
        Try

            If IsNumeric(dgv_9_empresa.CurrentRow.Cells(0).Value.ToString()) Then
                Cod_9 = dgv_9_empresa.CurrentRow.Cells(0).Value.ToString()
                txt_9_rut.Text = dgv_9_empresa.CurrentRow.Cells(5).Value.ToString()
                txt_9_empresa.Text = dgv_9_empresa.CurrentRow.Cells(6).Value.ToString()
                txt_9_n_ep.Text = dgv_9_empresa.CurrentRow.Cells(7).Value.ToString()
                version_mod9 = CInt(dgv_9_empresa.CurrentRow.Cells(2).Value.ToString())
            Else
                txt_9_empresa.Clear()
                txt_9_n_ep.Clear()
                txt_9_rut.Clear()
    ...
    Sub descargar_ep()
        ...
        If SaveFileDialog3.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            ruta_destino = SaveFileDialog3.FileName
            nombre = txt_9_rut.Text & "-" & txt_9_n_ep.Text & "-" & id_obra
            extension = ".pdf"
            Try

                My.Computer.Network.DownloadFile("ftp://cfv%2540constructorafv.com@201.148.105.75/Estados_Pago_Maq/" & nombre & extension & "", ruta_destino, "cfv@constructorafv.com", "gsolis2013", True, 100000, True)
    ...
    Private Sub txt_9_ep_TextChanged(sender As Object, e As EventArgs) Handles txt_9_ep.TextChanged
        If Not IsNumeric(txt_9_ep.Text) Then
            txt_9_ep.Clear()
        End If
    End Sub
End Class