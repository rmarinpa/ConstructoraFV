...
Public Class Libro_compras_v2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Libro_compras_v2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibro_compras_v2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Libro_compras_v2 = New Libro_compras_v2()
        rpt.Site = Me.Site
        Return rpt
    End Function
