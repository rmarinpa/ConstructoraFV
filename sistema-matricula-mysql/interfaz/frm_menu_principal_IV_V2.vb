...
Public Class frm_menu_principal_IV_V2
    ...
    Private Sub btn_eliminar1_Click(sender As Object, e As EventArgs) Handles btn_eliminar1.Click
        ...
        Else
            ...
            If nue_obra1.suma_avances(CInt(Cod_1), id_obra) = 0 Then
                ...
                'End If
            Else
                MessageBox.Show("NO SE PUEDE ELIMINAR EL SUBCONTRATO DADO QUE TIENE AVANCES INGRESADOS")
            End If
    ...
    Private Sub btn_eliminar11_Click(sender As Object, e As EventArgs) Handles btn_eliminar11.Click
        ...
        Else
            ...
            If nue_obra1.suma_subcontratos(txt_1_rut.Text, id_obra) = 0 Then
            ...
            Else
                MessageBox.Show("NO SE PUEDE ELIMINAR EL SUBCONTRATISTA DADO QUE TIENE SUBCONTRATOS ASIGNADOS")
            End If
