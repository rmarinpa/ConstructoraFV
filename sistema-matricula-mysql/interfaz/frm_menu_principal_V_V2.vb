...
Public Class frm_menu_principal_V_V2
    Dim nue_obra2 As New clases.Registro_petroleo
    Dim nue_obra3 As New clases.Facturas_petroleo
    Dim nue_obra7 As New clases.Storage
    Dim nue_obra9 As New clases.stock
    ...
    Sub bloquear9()
        dtp_9_fecha.Enabled = False
        txt_9_litros.Enabled = False

        btn_cancelar9.Enabled = False
        btn_guardar9.Enabled = False
        btn_editar9.Enabled = True
        btn_nuevo9.Enabled = True
        btn_eliminar9.Enabled = True
    End Sub
    Sub desbloquear9()
        dtp_9_fecha.Enabled = True
        txt_9_litros.Enabled = True

        btn_cancelar9.Enabled = True
        btn_guardar9.Enabled = True
        btn_editar9.Enabled = False
        btn_nuevo9.Enabled = False
        btn_eliminar9.Enabled = False
    End Sub
    Sub limpiar9()
        txt_9_litros.Clear()
    End Sub
    ...
    Sub bloquear4()
        ...
        cmb_3_asociar_guia.Enabled = False

        btn_cancelar4.Enabled = False
        btn_guardar4.Enabled = False
        btn_editar4.Enabled = True
        btn_nuevo4.Enabled = True
        btn_eliminar4.Enabled = True
    End Sub
    Sub desbloquear4()
        ...
        cmb_3_asociar_guia.Enabled = True

        btn_cancelar4.Enabled = True
        btn_guardar4.Enabled = True
        btn_editar4.Enabled = False
        btn_nuevo4.Enabled = False
        btn_eliminar4.Enabled = False
    End Sub
    Sub limpiar4()
        txt_3_precio.Clear()
        txt_3_iev.Clear()
    ...
    Private Sub btn_guardar3_Click(sender As Object, e As EventArgs) Handles btn_guardar3.Click
        Dim Proveedor, Rut As String
        Dim costo_adm, Litros As Double
        Dim Fecha As Date
        ...
        If (txt_3_num_factura.Text <> "" And txt_3_proveedor.Text <> "" And txt_3_rut.Text <> "" And txt_3_litros.Text <> "") Then
            ...
            If IsNumeric(txt_3_adm.Text) Then
            ...
            If sw3 = 0 Then
                nue_obra3.insertar(1, 0, Nombre_Obra, id_obra, Fecha, N_Factura, Proveedor, Rut, Litros, costo_adm)
                actualizar_dgv3()

            ElseIf sincroniza_local3 = 1 And sincroniza = 1 And sw3 <> 0 Then
                nue_obra3.modificar(CInt(Cod_3), 1, 0, Nombre_Obra, id_obra, Fecha, N_Factura, Proveedor, Rut, Litros, costo_adm)
                actualizar_dgv3()

            ElseIf sincroniza = 0 And sw3 <> 0 Then
                version_mod3 = version_mod3 + 1
                nue_obra3.modificar(CInt(Cod_3), 2, version_mod3, Nombre_Obra, id_obra, Fecha, N_Factura, Proveedor, Rut, Litros, costo_adm)
                actualizar_dgv3()
            Else
                version_mod3 = version_mod3 + 1
                nue_obra3.modificar(CInt(Cod_3), 2, version_mod3, Nombre_Obra, id_obra, Fecha, N_Factura, Proveedor, Rut, Litros, costo_adm)
    ...
    Sub actualizar_dgv3()
        ...
        dgv_3_compras.Columns(9).HeaderText = "Litros"
        dgv_3_compras.Columns(9).Width = 100
        dgv_3_compras.Columns(9).DefaultCellStyle.Format = "##,###.##"
        dgv_3_compras.Columns(10).Visible = False
        dgv_3_compras.AllowUserToOrderColumns = True
    End Sub

    Sub actualizar_dgv4()
        dgv_4_compras.DataSource = nue_obra3.listar_guias(id_obra, CInt(Cod_3))
        dgv_4_compras.Columns(0).Visible = False
        dgv_4_compras.Columns(1).Visible = False
        dgv_4_compras.Columns(2).Visible = False
        dgv_4_compras.Columns(3).Visible = False
        dgv_4_compras.Columns(4).Visible = False
        dgv_4_compras.Columns(5).HeaderText = "N° Guía"
        dgv_4_compras.Columns(5).Width = 100
        dgv_4_compras.Columns(5).DefaultCellStyle.Format = "##,###.##"
        dgv_4_compras.Columns(6).Visible = False
        dgv_4_compras.Columns(7).Visible = False
        dgv_4_compras.Columns(8).HeaderText = "Precio"
        dgv_4_compras.Columns(8).Width = 100
        dgv_4_compras.Columns(8).DefaultCellStyle.Format = "##,###.##"
        dgv_4_compras.Columns(9).Visible = False
        dgv_4_compras.Columns(10).Visible = False
        dgv_4_compras.Columns(11).Visible = False
        dgv_4_compras.Columns(12).HeaderText = "Precio Base"
        dgv_4_compras.Columns(12).Width = 100
        dgv_4_compras.Columns(12).DefaultCellStyle.Format = "##,###.##"
        dgv_4_compras.Columns(13).Visible = False
        dgv_4_compras.Columns(14).Visible = False
        dgv_4_compras.Columns(15).Visible = False
        dgv_4_compras.Columns(16).Visible = False
        dgv_4_compras.Columns(17).Visible = False
        dgv_4_compras.Columns(18).Visible = False

        dgv_4_compras.AllowUserToOrderColumns = True
    ...
    Sub actualizar_dgv9()
        dgv_9_stock.DataSource = nue_obra9.listar(id_obra)
        dgv_9_stock.Columns(0).Visible = False
        dgv_9_stock.Columns(1).Visible = False
        dgv_9_stock.Columns(2).Visible = False
        dgv_9_stock.Columns(3).Visible = False
        dgv_9_stock.Columns(4).Visible = False
        dgv_9_stock.Columns(5).HeaderText = "Litros"
        dgv_9_stock.Columns(5).Width = 100
        dgv_9_stock.Columns(5).DefaultCellStyle.Format = "##,###.##"
        dgv_9_stock.Columns(6).HeaderText = "Fecha"
        dgv_9_stock.Columns(6).Width = 100
        dgv_9_stock.AllowUserToOrderColumns = True
    End Sub
    ...
    Private Sub btn_guardar7_Click(sender As Object, e As EventArgs) Handles btn_guardar7.Click
        ...
        If (txt_7_litros.Text <> "" And txt_7_num_guia.Text <> "" And txt_7_precio.Text <> "") Then

            Obra = cmb_7_facturas.Text
            Litros = CDbl(txt_7_litros.Text)
            Fecha = CDate(dtp_7_fecha.Text)
            N_Guia = CDbl(txt_7_num_guia.Text)
            precio = CDbl(txt_7_precio.Text)


            If sw7 = 0 Then
                nue_obra7.insertar(1, 0, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra, precio)
                actualizar_dgv7()

            ElseIf sincroniza_local7 = 1 And sincroniza = 1 And sw7 <> 0 Then
                nue_obra7.modificar(CInt(Cod_7), 1, 0, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra, precio)
                actualizar_dgv7()

            ElseIf sincroniza = 0 And sw7 <> 0 Then
                version_mod7 = version_mod7 + 1
                nue_obra7.modificar(CInt(Cod_7), 2, version_mod7, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra, precio)
                actualizar_dgv7()
            Else
                version_mod7 = version_mod7 + 1
                nue_obra7.modificar(CInt(Cod_7), 2, version_mod7, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra, precio)
    ...
    Public Sub actualiza_guias()

        Try
            cmb_3_asociar_guia.DataSource = nue_obra7.listar3_guias(id_obra, dgv_4_compras.CurrentRow.Cells(5).Value.ToString())
            cmb_3_asociar_guia.DisplayMember = "N_Guia"
            cmb_3_asociar_guia.ValueMember = "Id_storage"
        Catch
            cmb_3_asociar_guia.DataSource = nue_obra7.listar3_guias(id_obra, 0)
            cmb_3_asociar_guia.DisplayMember = "N_Guia"
            cmb_3_asociar_guia.ValueMember = "Id_storage"
        End Try
    ...
    Private Sub btn_nuevo4_Click(sender As Object, e As EventArgs) Handles btn_nuevo4.Click
        If Cod_3 <> "" Then
            ...
            Me.dgv_4_compras.CurrentCell = Nothing
            actualiza_guias()
        Else
            MessageBox.Show("PRIMERO DEBE SELECCIONAR UNA FACTURA")

        End If
    End Sub

    Private Sub btn_editar4_Click(sender As Object, e As EventArgs) Handles btn_editar4.Click
        If (Cod_4 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            desbloquear4()
    ...
    Private Sub btn_cancelar4_Click(sender As Object, e As EventArgs) Handles btn_cancelar4.Click
        Me.dgv_4_compras.CurrentCell = Nothing
        actualiza_guias()
        bloquear4()
    End Sub

    Private Sub btn_guardar4_Click(sender As Object, e As EventArgs) Handles btn_guardar4.Click
        Dim Descuento, Imp_esp_var, Imp_esp_fijo, Precio_base, Total_neto, Total_Iva, Total_IEV, Total_IEF, Total_Compra, Precio, Litros As Double
        Dim n_guia, id_storage As Integer
        If Cod_3 = "" Then
            MessageBox.Show("PRIMERO DEBE SELECCIONAR UNA FACTURA")
        Else

            If (cmb_3_asociar_guia.Text <> "" And IsNumeric(txt_3_precio_base.Text)) Then
                ...
                Total_Compra = CDbl(txt_3_total_compra.Text)
                Precio = CDbl(txt_3_precio.Text)
                Litros = 0

                n_guia = cmb_3_asociar_guia.Text
                id_storage = CInt(cmb_3_asociar_guia.SelectedValue.ToString())

                If sw4 = 0 Then
                    nue_obra3.insertar_guia(1, 0, Nombre_Obra, id_obra, n_guia, id_storage, CInt(Cod_3), Precio, Descuento, Imp_esp_var, Imp_esp_fijo, Precio_base, Total_neto, Total_IEV, Total_IEF, Total_Iva, Total_Compra, Litros)
                    actualizar_dgv4()

                ElseIf sincroniza_local4 = 1 And sincroniza = 1 And sw4 <> 0 Then
                    nue_obra3.modificar_guia(CInt(Cod_4), 1, 0, Nombre_Obra, id_obra, n_guia, id_storage, CInt(Cod_3), Precio, Descuento, Imp_esp_var, Imp_esp_fijo, Precio_base, Total_neto, Total_IEV, Total_IEF, Total_Iva, Total_Compra, Litros)
                    actualizar_dgv4()

                ElseIf sincroniza = 0 And sw4 <> 0 Then
                    version_mod4 = version_mod4 + 1
                    nue_obra3.modificar_guia(CInt(Cod_4), 2, version_mod4, Nombre_Obra, id_obra, n_guia, id_storage, CInt(Cod_3), Precio, Descuento, Imp_esp_var, Imp_esp_fijo, Precio_base, Total_neto, Total_IEV, Total_IEF, Total_Iva, Total_Compra, Litros)
                    actualizar_dgv4()
                Else
                    version_mod4 = version_mod4 + 1
                    nue_obra3.modificar_guia(CInt(Cod_4), 2, version_mod4, Nombre_Obra, id_obra, n_guia, id_storage, CInt(Cod_3), Precio, Descuento, Imp_esp_var, Imp_esp_fijo, Precio_base, Total_neto, Total_IEV, Total_IEF, Total_Iva, Total_Compra, Litros)
    ...
    Private Sub btn_eliminar4_Click(sender As Object, e As EventArgs) Handles btn_eliminar4.Click
        Dim eliminar4 As MsgBoxResult
        If (Cod_4 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            eliminar4 = MsgBox("¿Realmente desea eliminar el registro?", MsgBoxStyle.YesNo, "Confirmar")

            If eliminar4 = MsgBoxResult.Yes And sincroniza = 0 Then
                version_mod4 = version_mod4 + 1
                nue_obra3.eliminar_sincro_guia(CInt(Cod_4), 3, version_mod4)
                actualizar_dgv4()
                bloquear4()
                limpiar4()

            ElseIf sincroniza_local4 = 1 And sincroniza = 1 And eliminar4 = MsgBoxResult.Yes Then
                nue_obra3.eliminar_guia(CInt(Cod_4))
                actualizar_dgv4()
                bloquear4()
                limpiar4()

            ElseIf eliminar4 = MsgBoxResult.Yes Then
                version_mod4 = version_mod4 + 1
                nue_obra3.eliminar_sincro_guia(CInt(Cod_4), 3, version_mod4)
                actualizar_dgv4()
                bloquear4()
    ...
    Private Sub txt_4_litros_TextChanged(sender As Object, e As EventArgs) Handles txt_4_litros.TextChanged
        If Not IsNumeric(txt_4_litros.Text) Then
            txt_4_litros.Clear()
        End If
    ...
    Private Sub cmb_3_asociar_guia_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_3_asociar_guia.SelectedIndexChanged
        If IsNumeric(cmb_3_asociar_guia.SelectedValue.ToString()) Then
            txt_4_litros.Text = nue_obra3.litros_guia(cmb_3_asociar_guia.SelectedValue.ToString(), id_obra)
            txt_3_precio.Text = nue_obra3.precio_guia(cmb_3_asociar_guia.SelectedValue.ToString(), id_obra)
        End If
    End Sub

    Private Sub btn_nuevo9_Click(sender As Object, e As EventArgs) Handles btn_nuevo9.Click
        desbloquear9()
        limpiar9()
        sw9 = 0
        Cod_9 = ""
    ...
    Private Sub btn_editar9_Click(sender As Object, e As EventArgs) Handles btn_editar9.Click
        If (Cod_9 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            desbloquear9()
    ...
    Private Sub btn_cancelar9_Click(sender As Object, e As EventArgs) Handles btn_cancelar9.Click
        bloquear9()
    End Sub

    Private Sub btn_guardar9_Click(sender As Object, e As EventArgs) Handles btn_guardar9.Click
        Dim Litros As Double
        Dim Fecha As Date

        If (txt_9_litros.Text <> "") Then

            Litros = CDbl(txt_9_litros.Text)
            Fecha = CDate(dtp_9_fecha.Text)

            If sw9 = 0 Then
                nue_obra9.insertar(1, 0, Nombre_Obra, id_obra, Litros, Fecha)
                actualizar_dgv9()

            ElseIf sincroniza_local9 = 1 And sincroniza = 1 And sw9 <> 0 Then
                nue_obra9.modificar(CInt(Cod_9), 1, 0, Nombre_Obra, id_obra, Litros, Fecha)
                actualizar_dgv9()

            ElseIf sincroniza = 0 And sw9 <> 0 Then
                version_mod9 = version_mod9 + 1
                nue_obra9.modificar(CInt(Cod_9), 2, version_mod9, Nombre_Obra, id_obra, Litros, Fecha)
                actualizar_dgv9()
            Else
                version_mod9 = version_mod9 + 1
                nue_obra9.modificar(CInt(Cod_9), 2, version_mod9, Nombre_Obra, id_obra, Litros, Fecha)
    ...
    Private Sub btn_eliminar9_Click(sender As Object, e As EventArgs) Handles btn_eliminar9.Click
        Dim eliminar9 As MsgBoxResult
        If (Cod_9 = "") Then
            MessageBox.Show("SELECCIONA UN REGISTRO")
        Else
            eliminar9 = MsgBox("¿Realmente desea eliminar el registro?", MsgBoxStyle.YesNo, "Confirmar")

            If eliminar9 = MsgBoxResult.Yes And sincroniza = 0 Then
                version_mod9 = version_mod9 + 1
                nue_obra9.eliminar_sincro(CInt(Cod_9), 3, version_mod9)
                actualizar_dgv9()
                bloquear9()
                limpiar9()

            ElseIf sincroniza_local9 = 1 And sincroniza = 1 And eliminar9 = MsgBoxResult.Yes Then
                nue_obra9.eliminar(CInt(Cod_9))
                actualizar_dgv9()
                bloquear9()
                limpiar9()

            ElseIf eliminar9 = MsgBoxResult.Yes Then
                version_mod9 = version_mod9 + 1
                nue_obra9.eliminar_sincro(CInt(Cod_9), 3, version_mod9)
                actualizar_dgv9()
                bloquear9()
