Public Class CR_Libro_combustible_diesel2
    ...
    Private Sub CR_Estado_de_pago_Load(sender As Object, e As EventArgs) Handles Me.Load
        If sincroniza = 0 Then
            ...
            Report1.SetParameterValue("stock_anterior", frm_menu_principal_V_V2.txt_8_stock_anterior.Text)
