Public Class frm_menu_principal_II
    ...
    Private Sub btn_guardar1_Click(sender As Object, e As EventArgs) Handles btn_guardar1.Click
        ...
        If (txt_1_nom_obra.Text <> "" And txt_1_nom_faena.Text <> "" And txt_1_prof_residente.Text <> "") Then
            ...
            If sw1 = 0 Then
                nue_obra1.insertar(1, 0, Nombre_Obra, id_obra, nombre_faena, prof_residente, rut_prof_residente, jefe_oficina, gerente_cargo, mandante, num_resolucion, fecha_resol, fecha_inicio, plazo, fecha_fin, monto, detalle_obra)
                actualizar_dgv1()

            ElseIf sincroniza_local = 1 And sincroniza = 1 And sw1 <> 0 Then
                nue_obra1.modificar(CInt(Cod_1), 1, 0, Nombre_Obra, id_obra, nombre_faena, prof_residente, rut_prof_residente, jefe_oficina, gerente_cargo, mandante, num_resolucion, fecha_resol, fecha_inicio, plazo, fecha_fin, monto, detalle_obra)
                actualizar_dgv1()

            ElseIf sincroniza = 0 And sw1 <> 0 Then
                version_mod1 = version_mod1 + 1
                nue_obra1.modificar(CInt(Cod_1), 2, version_mod1, Nombre_Obra, id_obra, nombre_faena, prof_residente, rut_prof_residente, jefe_oficina, gerente_cargo, mandante, num_resolucion, fecha_resol, fecha_inicio, plazo, fecha_fin, monto, detalle_obra)
                actualizar_dgv1()
            Else
                version_mod1 = version_mod1 + 1
                nue_obra1.modificar(CInt(Cod_1), 2, version_mod1, Nombre_Obra, id_obra, nombre_faena, prof_residente, rut_prof_residente, jefe_oficina, gerente_cargo, mandante, num_resolucion, fecha_resol, fecha_inicio, plazo, fecha_fin, monto, detalle_obra)
