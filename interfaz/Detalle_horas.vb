...
Public Class Detalle_horas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Detalle_horas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDetalle_horas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Detalle_horas = New Detalle_horas()
        rpt.Site = Me.Site
        Return rpt
    End Function
