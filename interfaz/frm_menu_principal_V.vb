...
Public Class frm_menu_principal_V
    ...
    Private Sub Button64_Click(sender As Object, e As EventArgs) Handles btn_fecha.Click
        ...
        If chk_codigo.Checked = True Then
            codigo_libre = 1
        ElseIf chk_codigo.Checked = False Then
            codigo_libre = 0
        End If
    ...
    Public Sub actualiza_equipos()
        cmb_equipo.DataSource = nue_obra2.listar2(id_obra)
    ...
    Private Sub btn_guardar7_Click(sender As Object, e As EventArgs) Handles btn_guardar7.Click
        ...
        If (txt_7_litros.Text <> "" And txt_7_num_guia.Text <> "") Then
            ...
            If sw7 = 0 Then
                nue_obra7.insertar(1, 0, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra)
                actualizar_dgv7()

            ElseIf sincroniza_local7 = 1 And sincroniza = 1 And sw7 <> 0 Then
                nue_obra7.modificar(CInt(Cod_7), 1, 0, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra)
                actualizar_dgv7()

            ElseIf sincroniza = 0 And sw7 <> 0 Then
                version_mod7 = version_mod7 + 1
                nue_obra7.modificar(CInt(Cod_7), 2, version_mod7, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra)
                actualizar_dgv7()
            Else
                version_mod7 = version_mod7 + 1
                nue_obra7.modificar(CInt(Cod_7), 2, version_mod7, Nombre_Obra, id_obra, N_Guia, Litros, Fecha, Obra)
    ...
    Sub LimpiarEstado()
        ...
        txtObservaciones.Text = ""
    End Sub
    Private Sub FormatearValores()
        Try
            txtRetenciones.Text = FormatCurrency(txtRetenciones.Text)
            txtValorEstadoPago.Text = FormatCurrency(txtValorEstadoPago.Text)
            txtValorEstadoPagoNeto.Text = FormatCurrency(txtValorEstadoPagoNeto.Text)
            txtObrasNeto.Text = FormatCurrency(txtObrasNeto.Text)
            txtReajusteNeto.Text = FormatCurrency(txtReajusteNeto.Text)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub

    Public Sub DesformateoValores()
        Try
            txtRetenciones.Text = FormatNumber(txtRetenciones.Text, 0)
            txtValorEstadoPago.Text = FormatNumber(txtValorEstadoPago.Text, 0)
            txtValorEstadoPagoNeto.Text = FormatNumber(txtValorEstadoPagoNeto.Text, 0)
            txtObrasNeto.Text = FormatNumber(txtObrasNeto.Text, 0)
            txtReajusteNeto.Text = FormatNumber(txtReajusteNeto.Text, 0)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    Sub actualizar_dgvestados()
        Try
            ...
            With dgvEstadoPago
                ...
                .Columns(4).HeaderCell.Value = "Nro Factura"
                .Columns(5).HeaderCell.Value = "Valor Obra"
            ...
            dgvEstadoPago.Columns(14).AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells
    ...
    Private Sub dgvEstadoPago_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvEstadoPago.CellContentClick
        ...
        Try
            ...
            cboObras.Text = selectRow.Cells(1).Value.ToString()
            txtNroEstadoPago.Text = selectRow.Cells(2).Value.ToString()
            dtFecha.Value = selectRow.Cells(3).Value
            txtNroFatura.Text = selectRow.Cells(4).Value.ToString()
    ...
    Private Sub btnSubir_Click(sender As Object, e As EventArgs) Handles btnSubir.Click
        Try
            My.Computer.Network.UploadFile(TextBox3.Text, "ftp://201.148.105.75/DirectorioPrueba" + "/" + lblNombreArchivo.Text, "cfv@constructorafv.com", "gsolis2013", True, 500)
            InsertarFtp()
            MsgBox("Archivo " + lblNombreArchivo.Text + " subido correctamente")
            Actualizar_dgvEstadosPagoFirmado()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub btnDescargar_Click(sender As Object, e As EventArgs) Handles btnDescargar.Click
        Try
            FTPDownloadFile("C:\Users\USUARIO\Pictures\Saved Pictures\" + txtNombreArchivo.Text + "", "ftp://201.148.105.75/DirectorioPrueba/" + txtNombreArchivo.Text + "", "cfv@constructorafv.com", "gsolis2013")
            'My.Computer.Network.UploadFile(TextBox3.Text, ComboBox1.SelectedItem + TextBox4.Text + "/" + Label69.Text, txtUser.Text, txtPass.Text, True, 500)
            'My.Computer.Network.DownloadFile("ftp://201.148.105.75/DirectorioPrueba/isla.jpg", "C:\Intel")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Public Sub InsertarFtp()
        Try
            Dim obra As String
            Dim nroEstadoPago As Integer
            Dim adjunto As String
            Dim usuario As String
            Dim fecha As DateTime
            obra = cboObras.Text
            nroEstadoPago = txtNroEstadoPagoFirmado.Text
            adjunto = lblNombreArchivo.Text
            usuario = Nombre_Usuario
            fecha = DateTime.Now

            nue_obra6.InsertarEstadoPagoFirmado(obra, nroEstadoPago, adjunto, usuario, fecha)
            MsgBox("Se insertó correctamente")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Sub Actualizar_dgvEstadosPagoFirmado()
        Try
            Dim total As Double = 0
            Dim fila As DataGridViewRow = New DataGridViewRow()
            dgvAdjuntosPagosFirmados.DataSource = nue_obra6.LeerAdjuntoPagosFirmados(Nombre_Obra)
    ...
    Private Sub dgvAdjuntosPagosFirmados_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvAdjuntosPagosFirmados.CellContentClick
    ...
    Private Sub dgvAdjuntosPagosFirmados_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvAdjuntosPagosFirmados.CellContentDoubleClick
        Try
            Dim index As Integer
            index = e.RowIndex
            Dim selectRow As DataGridViewRow
    ...
    '        txtRetencionesActual.Text = Convert.ToString(total)
    '        txtRetencionesActual.Text = FormatCurrency(txtRetencionesActual.Text)
    ...
    'Private Sub txtRetenciones_TextChanged(sender As Object, e As EventArgs) Handles txtRetenciones.TextChanged
    '    Try
    '        txtRetenciones.Select(txtRetenciones.Text.Length, 1)
    '        txtRetenciones.ScrollToCaret()
    '        txtRetenciones.Text = FormatCurrency(txtRetenciones.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    'End Try

    'End Sub

    'Private Sub txtRetencionesCanjeadas_TextChanged(sender As Object, e As EventArgs) Handles txtRetencionesCanjeadas.TextChanged
    '    Try
    '        txtRetencionesCanjeadas.Select(txtRetencionesCanjeadas.Text.Length, 1)
    '        txtRetencionesCanjeadas.ScrollToCaret()
    '        txtRetencionesCanjeadas.Text = FormatCurrency(txtRetencionesCanjeadas.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    'End Sub
    ...
    '    Try
    '        txtMultas.Select(txtMultas.Text.Length, 1)
    '        txtMultas.ScrollToCaret()
    '        txtMultas.Text = FormatCurrency(txtMultas.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    'End Sub

    'Private Sub txtValorEstadoPago_TextChanged(sender As Object, e As EventArgs) Handles txtValorEstadoPago.TextChanged
    '    Try
    '        txtValorEstadoPago.Select(txtValorEstadoPago.Text.Length, 1)
    '        txtValorEstadoPago.ScrollToCaret()
    '        txtValorEstadoPago.Text = FormatCurrency(txtValorEstadoPago.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    ...
    'Private Sub txtValorEstadoPagoNeto_TextChanged(sender As Object, e As EventArgs) Handles txtValorEstadoPagoNeto.TextChanged
    '    Try
    '        txtValorEstadoPagoNeto.Select(txtValorEstadoPagoNeto.Text.Length, 1)
    '        txtValorEstadoPagoNeto.ScrollToCaret()
    '        txtValorEstadoPagoNeto.Text = FormatCurrency(txtValorEstadoPagoNeto.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    ...
    'Private Sub txtObrasNeto_TextChanged(sender As Object, e As EventArgs) Handles txtObrasNeto.TextChanged
    '    Try
    '        txtObrasNeto.Select(txtObrasNeto.Text.Length, 1)
    '        txtObrasNeto.ScrollToCaret()
    '        txtObrasNeto.Text = FormatCurrency(txtObrasNeto.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    ...
    'Private Sub txtReajusteNeto_TextChanged(sender As Object, e As EventArgs) Handles txtReajusteNeto.TextChanged
    '    Try
    '        txtReajusteNeto.Select(txtReajusteNeto.Text.Length, 1)
    '        txtReajusteNeto.ScrollToCaret()
    '        txtReajusteNeto.Text = FormatCurrency(txtReajusteNeto.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    ...
    '    Try
    '        txtObservaciones.Select(txtObservaciones.Text.Length, 1)
    '        txtObservaciones.ScrollToCaret()
    '        txtObservaciones.Text = FormatCurrency(txtObservaciones.Text)
    '    Catch ex As Exception
    '        MsgBox("Error, formato desconodido", MsgBoxStyle.Critical)
    '    End Try
    'End Sub
